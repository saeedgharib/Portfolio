...
export default function ThreeScene() {
  ...
  useEffect(() => {
    ...
    const addTextPlaceholders = () => {
      // Create placeholder text meshes using simple planes
      const createTextPlaceholder = (text: string, position: [number, number, number], color: number) => {
        const group = new THREE.Group()

        // Create a background plane
        const planeGeometry = new THREE.PlaneGeometry(text.length * 0.8, 1.5)
      ...
      // Create placeholder text meshes
      createTextPlaceholder("Developer", [-5, 2, 0], 0x4285f4)
      createTextPlaceholder("Designer", [4, -1, 1], 0x5e35b1)
      createTextPlaceholder("Creator", [0, 3, -2], 0x0070f3)
    }
